...
void scn_1_setInputBatchSpatialLocations(
  void **m, THFloatTensor *features_, THLongTensor *locations_, THFloatTensor *vecs_, THLongTensor *nz_nums_);
...
void scn_1_getLocationsIndexInRef(void **m, void **m_ref, THLongTensor *spatialSize, THLongTensor *indexs_);
long scn_1_concatTensor(void **m, void **in1, void **in2, THLongTensor *spatialSize, THLongTensor *idx1_, THLongTensor *idx2_);
...
void scn_2_createMetadataForDenseToSparse(
  void **m, THLongTensor *spatialSize_, THLongTensor *nz, long batchSize);
void scn_2_setInputBatchSpatialLocations(
  void **m, THFloatTensor *features_, THLongTensor *locations_, THFloatTensor *vecs_, THLongTensor *nz_nums_);
...
void scn_2_getSpatialLocations(void **m, THLongTensor *spatialSize,
    THLongTensor *locations);
void scn_2_getLocationsIndexInRef(void **m, void **m_ref, THLongTensor *spatialSize, THLongTensor *indexs_);
long scn_2_concatTensor(void **m, void **in1, void **in2, THLongTensor *spatialSize, THLongTensor *idx1_, THLongTensor *idx2_);
...
void scn_3_createMetadataForDenseToSparse(
  void **m, THLongTensor *spatialSize_, THLongTensor *nz, long batchSize);
void scn_3_setInputBatchSpatialLocations(
  void **m, THFloatTensor *features_, THLongTensor *locations_, THFloatTensor *vecs_, THLongTensor *nz_nums_);
...
void scn_3_getSpatialLocations(void **m, THLongTensor *spatialSize,
    THLongTensor *locations);
void scn_3_getLocationsIndexInRef(void **m, void **m_ref, THLongTensor *spatialSize, THLongTensor *indexs_);
long scn_3_concatTensor(void **m, void **in1, void **in2, THLongTensor *spatialSize, THLongTensor *idx1_, THLongTensor *idx2_);
void scn_3_extractStructure(void **m, THLongTensor *spatialSize, THLongTensor *label, THLongTensor *subset, THLongTensor *kernel_size);
void scn_3_extractStructure2(void **m, THLongTensor *spatialSize, THFloatTensor *p_, THLongTensor *label_, THLongTensor *subset_, THLongTensor *kernel_size_, float p_threshold);
void scn_3_getSampleWeight(void **m, THLongTensor *spatialSize, THFloatTensor *sample_, THLongTensor *position_, THFloatTensor *val_);
// void scn_3_precomputeValidRules(void **m, THLongTensor *inputSize, THLongTensor *filterSize);
void scn_3_getConvMask(void **m, THLongTensor *inputSize, THLongTensor *filterSize, THFloatTensor *mask);
void scn_3_getValidRules(void **m, THLongTensor *inputSize, THLongTensor *filterSize);
void scn_3_getConvRulesAndOutput(void **m, THLongTensor *inputSize, THLongTensor *outputSize, THLongTensor *filterSize, THLongTensor *stride);
void scn_3_getConvRules2AndOutput(void **m, THLongTensor *inputSize, THLongTensor *outputSize, THLongTensor *filterSize, THLongTensor *stride);
...
void scn_4_createMetadataForDenseToSparse(
  void **m, THLongTensor *spatialSize_, THLongTensor *nz, long batchSize);
void scn_4_setInputBatchSpatialLocations(
  void **m, THFloatTensor *features_, THLongTensor *locations_, THFloatTensor *vecs_, THLongTensor *nz_nums_);
...
void scn_4_getSpatialLocations(void **m, THLongTensor *spatialSize,
    THLongTensor *locations);
void scn_4_getLocationsIndexInRef(void **m, void **m_ref, THLongTensor *spatialSize, THLongTensor *indexs_);
long scn_4_concatTensor(void **m, void **in1, void **in2, THLongTensor *spatialSize, THLongTensor *idx1_, THLongTensor *idx2_);
...
void scn_5_createMetadataForDenseToSparse(
  void **m, THLongTensor *spatialSize_, THLongTensor *nz, long batchSize);
void scn_5_setInputBatchSpatialLocations(
  void **m, THFloatTensor *features_, THLongTensor *locations_, THFloatTensor *vecs_, THLongTensor *nz_nums_);
...
void scn_5_getSpatialLocations(void **m, THLongTensor *spatialSize,
    THLongTensor *locations);
void scn_5_getLocationsIndexInRef(void **m, void **m_ref, THLongTensor *spatialSize, THLongTensor *indexs_);
long scn_5_concatTensor(void **m, void **in1, void **in2, THLongTensor *spatialSize, THLongTensor *idx1_, THLongTensor *idx2_);
...
void scn_6_createMetadataForDenseToSparse(
  void **m, THLongTensor *spatialSize_, THLongTensor *nz, long batchSize);
void scn_6_setInputBatchSpatialLocations(
  void **m, THFloatTensor *features_, THLongTensor *locations_, THFloatTensor *vecs_, THLongTensor *nz_nums_);
...
void scn_6_getSpatialLocations(void **m, THLongTensor *spatialSize,
    THLongTensor *locations);
void scn_6_getLocationsIndexInRef(void **m, void **m_ref, THLongTensor *spatialSize, THLongTensor *indexs_);
long scn_6_concatTensor(void **m, void **in1, void **in2, THLongTensor *spatialSize, THLongTensor *idx1_, THLongTensor *idx2_);
...
void scn_7_createMetadataForDenseToSparse(
  void **m, THLongTensor *spatialSize_, THLongTensor *nz, long batchSize);
void scn_7_setInputBatchSpatialLocations(
  void **m, THFloatTensor *features_, THLongTensor *locations_, THFloatTensor *vecs_, THLongTensor *nz_nums_);
...
void scn_7_getSpatialLocations(void **m, THLongTensor *spatialSize,
    THLongTensor *locations);
void scn_7_getLocationsIndexInRef(void **m, void **m_ref, THLongTensor *spatialSize, THLongTensor *indexs_);
long scn_7_concatTensor(void **m, void **in1, void **in2, THLongTensor *spatialSize, THLongTensor *idx1_, THLongTensor *idx2_);
...
void scn_8_createMetadataForDenseToSparse(
  void **m, THLongTensor *spatialSize_, THLongTensor *nz, long batchSize);
void scn_8_setInputBatchSpatialLocations(
  void **m, THFloatTensor *features_, THLongTensor *locations_, THFloatTensor *vecs_, THLongTensor *nz_nums_);
...
void scn_8_getSpatialLocations(void **m, THLongTensor *spatialSize,
    THLongTensor *locations);
void scn_8_getLocationsIndexInRef(void **m, void **m_ref, THLongTensor *spatialSize, THLongTensor *indexs_);
long scn_8_concatTensor(void **m, void **in1, void **in2, THLongTensor *spatialSize, THLongTensor *idx1_, THLongTensor *idx2_);
...
void scn_9_createMetadataForDenseToSparse(
  void **m, THLongTensor *spatialSize_, THLongTensor *nz, long batchSize);
void scn_9_setInputBatchSpatialLocations(
  void **m, THFloatTensor *features_, THLongTensor *locations_, THFloatTensor *vecs_, THLongTensor *nz_nums_);
...
void scn_9_getSpatialLocations(void **m, THLongTensor *spatialSize,
    THLongTensor *locations);
void scn_9_getLocationsIndexInRef(void **m, void **m_ref, THLongTensor *spatialSize, THLongTensor *indexs_);
long scn_9_concatTensor(void **m, void **in1, void **in2, THLongTensor *spatialSize, THLongTensor *idx1_, THLongTensor *idx2_);
...
void scn_10_createMetadataForDenseToSparse(
  void **m, THLongTensor *spatialSize_, THLongTensor *nz, long batchSize);
void scn_10_setInputBatchSpatialLocations(
  void **m, THFloatTensor *features_, THLongTensor *locations_, THFloatTensor *vecs_, THLongTensor *nz_nums_);
...
void scn_10_getSpatialLocations(void **m, THLongTensor *spatialSize,
    THLongTensor *locations);
void scn_10_getLocationsIndexInRef(void **m, void **m_ref, THLongTensor *spatialSize, THLongTensor *indexs_);
long scn_10_concatTensor(void **m, void **in1, void **in2, THLongTensor *spatialSize, THLongTensor *idx1_, THLongTensor *idx2_);
