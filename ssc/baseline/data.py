...
def SUNCG_DATA():
    ...
    # you can use only 200 data for a quick test: python sscnet.py --train_num=50
    # SUNCG['train_data_num'] = 200
...
def train(DATASET, used_train_num):
    ...
    def sampler(dataset, idx):
        return randperm[idx]
    d = torchnet.dataset.ResampleDataset(d, sampler=sampler, size=used_train_num*train_batch_size)
